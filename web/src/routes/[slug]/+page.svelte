    ...
    <article class="bg-white rounded-lg border overflow-hidden">
      <div class="px-6 pt-6 pb-2">
        ...
        <div class="flex flex-wrap items-center gap-3 text-xs text-gray-500 mt-3 pb-4 border-b">
          <span class="font-medium text-gray-700">Penulis: <span class="text-red-600 font-normal">Redaksi Kubus</span></span>
      ...
      <div class="px-6 py-6">
        ...
        <div class="flex gap-4 mt-8 p-4 bg-gray-50 rounded-lg border">
          <div class="w-16 h-16 rounded-full bg-gray-200 shrink-0 overflow-hidden">
            <img src="https://secure.gravatar.com/avatar/94b1f7ab91df21de82cc1bbfedb4bd1859bf805a9c3e841d8aeaf6702257ed36?s=96&d=mm&r=g" alt="Redaksi Kubus" class="w-full h-full object-cover" />
          </div>
          <div>
            <div class="font-bold text-sm text-gray-900">Redaksi Kubus</div>
            <p class="text-xs text-gray-500 mt-1">Portal berita bagian dari ANDIKA MediaNet (Radio ANDIKA dan ANDIKA TV).</p>
